...
const definition = 'EvolutiveCocoon2.gh'
...
const Radius1_slider = document.getElementById( 'SP_Radius1' )
...
const Radius2_slider = document.getElementById( 'SP_Radius2' )
...
const Radius3_slider = document.getElementById( 'SP_Radius3' )
Radius3_slider.addEventListener( 'mouseup', onSliderChange, false )
Radius3_slider.addEventListener( 'touchend', onSliderChange, false )
const Radius4_slider = document.getElementById( 'SP_Radius4' )
Radius4_slider.addEventListener( 'mouseup', onSliderChange, false )
Radius4_slider.addEventListener( 'touchend', onSliderChange, false )
...
async function compute () {
  ...
  const data = {
    ...
    inputs: {
      ...
      'SP_Radius1': Radius1_slider.valueAsNumber,
      'SP_Radius2': Radius2_slider.valueAsNumber,
      'SP_Radius3': Radius3_slider.valueAsNumber,
      'SP_Radius4': Radius4_slider.valueAsNumber,
      'SP_Radius5': Radius5_slider.valueAsNumber,
      'RH_IN:SUNLIGHT ANALYSIS' : checkbox.checked,
      'points': points
    }
  }
 ...
 * slider values and call compute to solve for a new scenenp
 */
